...
roc_nn_train = roc(as.numeric(neural_network_train$trainingData$.outcome=='Unhealthy'),
                   aggregate(Unhealthy~rowIndex,neural_network_train$pred,mean)[,'Unhealthy'], ci=T)
